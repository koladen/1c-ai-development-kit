...
name: subsystem-edit
description: >
  Этот скилл MUST быть вызван когда нужно добавить или удалить объекты из подсистемы, управлять дочерними подсистемами или изменить свойства.
  SHOULD также вызывать после meta-compile для включения новых объектов в подходящую подсистему.
  Do NOT использовать для создания подсистемы — используй subsystem-compile; для настройки интерфейса — используй interface-edit.
