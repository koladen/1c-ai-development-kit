...
description: >
  Этот скилл MUST быть вызван когда пользователь просит добавить или создать подсистему (раздел) в конфигурации 1С.
  SHOULD также вызывать при организации объектов конфигурации в логические группы.
  Do NOT использовать для редактирования существующей подсистемы — используй subsystem-edit; для настройки интерфейса — используй interface-edit.
