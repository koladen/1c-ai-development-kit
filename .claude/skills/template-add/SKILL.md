...
name: template-add
description: >
  Этот скилл MUST быть вызван когда нужно добавить макет к объекту 1С: обработка, отчёт, справочник, документ.
  SHOULD также вызывать при добавлении макета печатной формы или шаблона данных к объекту.
  Do NOT использовать для удаления макета — используй template-remove; для создания содержимого MXL — используй mxl-compile.
