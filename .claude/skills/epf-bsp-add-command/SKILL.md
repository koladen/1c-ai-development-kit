...
description: >
  Этот скилл MUST быть вызван когда нужно добавить команду в дополнительную обработку БСП.
  SHOULD также вызывать после epf-bsp-init когда обработка должна экспортировать дополнительные команды.
  Do NOT использовать для регистрации обработки в БСП — используй epf-bsp-init.
