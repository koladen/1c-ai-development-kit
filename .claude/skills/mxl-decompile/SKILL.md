...
name: mxl-decompile
description: >
  Этот скилл MUST быть вызван когда нужно получить редактируемое JSON-описание существующего MXL-макета.
  SHOULD также вызывать перед модификацией существующей печатной формы.
  Do NOT использовать для создания MXL — используй mxl-compile; для анализа MXL — используй mxl-info.
