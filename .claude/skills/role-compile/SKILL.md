...
name: role-compile
description: >
  Этот скилл MUST быть вызван когда нужно создать новую роль 1С с набором прав на объекты из описания.
  SHOULD также вызывать при настройке разграничения доступа для новой функциональности.
  Do NOT использовать для модификации существующей роли — используй meta-edit; для анализа роли — используй role-info.
